...
class GetEmpresaSessionUseCase {
  final EmpresaAuthRepository empresaAuthRepository;

  GetEmpresaSessionUseCase(this.empresaAuthRepository);

  Future<AuthResponse?> run() {
    return empresaAuthRepository.getEmpresaSession();
  }
}