...
class EmpresaCard extends StatelessWidget {
  ...
  final VoidCallback? onSelectedEmpresa;

  const EmpresaCard({
    super.key,
    required this.empresa,
    this.onSelectedEmpresa,
  });
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        ...
        onTap: onSelectedEmpresa ?? () {
          // Default behavior if no callback provided
          _showSelectionDialog(context, empresa);
        },
      ),
    );
  }

  void _showSelectionDialog(BuildContext context, Empresa empresa) {
    showDialog(
      context: context,
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              // This can be overridden by the parent
            },
